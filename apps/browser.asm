...
; --- Icon Header (80 bytes: 0x00-0x4F) ---
    ...
    ; Folder icon: white outline folder shape
    db 0x0F, 0xFC, 0x00, 0x00      ; Row 0
    db 0x3F, 0xFF, 0x00, 0x00      ; Row 1
    db 0xFF, 0xFF, 0xFF, 0xFC      ; Row 2
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 3
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 4
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 5
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 6
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 7
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 8
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 9
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 10
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 11
    db 0xC0, 0x00, 0x00, 0x0C      ; Row 12
    db 0xFF, 0xFF, 0xFF, 0xFC      ; Row 13
