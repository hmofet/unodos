...
But the GG's LCD shows only the **centre 160×144 of the 256×192 frame = 20×18 cells**: which is exactly the [Game Boy's panel](../gb/README.md). So the Game Gear wears
