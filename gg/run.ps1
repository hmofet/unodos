# run.ps1, launch the Game Gear ROM in Mesen2 and capture the framebuffer.
#
...
# Unlike the NES (256x240 -> 3x overflows), the GG visible frame is 160x144 so even at
# Mesen's 3x (480x432) the whole frame fits the window, no top-left crop.
param(
  [string]$Rom = "build\unodos.gg",
