#!/usr/bin/env python3
"""Write the UnoDOS FAT12 filesystem into a packed MacPlus boot disk.
...
starting at FS_START_SECTOR -- the same place the kernel's sony.i reads it
