// ============================================================================
// UnoDOS / Cosmo Communicator — full-screen apps (M3), clock/theme/music,
...
l_paint:   .asciz "Paint"
s_title:   .asciz "UnoDOS 3 - Cosmo Communicator"
s_back:    .asciz "B = Back"
s_usb:     .asciz "USB:"
...
c_sysinfo:
    ...
    .word 16, 172, m_si4
    .word 0xFFFFFFFF
m_si0: .asciz "UnoDOS 3 - Cosmo Communicator"
m_si1: .asciz "CPU  MediaTek MT6771 (A73+A53)"
...
m_np2: .asciz "first non-Linux OS on MediaTek"
.align 2
c_files:
    .word 16, 48, m_fi0
    .word 16, 96, m_fi1
...
c_generic:
    ...
    .word 16, 96, m_ge1
    .word 0xFFFFFFFF
m_ge0: .asciz "UnoDOS 3 / Cosmo Communicator"
