// ============================================================================
// UnoDOS / Cosmo Communicator — USV1 byte-heap filesystem (ported from
...
.equ FSBASE,      0x40340000            // cosmo: VARS+0x40000 in MT6771 DRAM (was 0x340000 on the Pi)
...
notes_name:       .ascii "NOTES.TXT"
                  .byte 0,0,0
seed_readme:
    .ascii "UnoDOS / Cosmo Communicator.\r"
