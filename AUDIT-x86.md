...
`kernel_size` from the directory entry (`stage2_hd.asm:229-231`) **but never uses it**: it loads cluster-by-cluster until end-of-chain, advancing `ES:DI` with a 64 KB
