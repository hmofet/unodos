...
The last seven are built **fresh on the 3.1 contract-driven architecture** (not
...
and **WonderSwan** is the first **x86 handheld** (NEC V30MZ ≈ 80186, nasm), a
hardware-tile launcher. The three newest are each verified on a **ROM-free
instruction-level harness** (Unicorn ARM / py65 / Unicorn x86) where a focus-
independent emulator capture is impractical. They are not yet in the per-feature
grids below (which cover the mature legacy targets); see
