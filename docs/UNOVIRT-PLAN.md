...
> **Status: Track A phases A0..A6 are BUILT and pass on VMX** (devbuntu, bare
> metal, nested KVM); a real Ubuntu kernel boots under UnoDOS and its shell
> reads a command and answers, 2026-08-07. Everything else below - A7 onwards,
> and all of Tracks B and C - is still plan. The phase table in §7 is the
> authority on which is which, and `pc64/UNOVIRT.md` carries the findings.
