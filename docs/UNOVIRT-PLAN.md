...
> **Status: Track A phases A0..A7 are BUILT and pass on VMX** (nested-KVM
...
> of a file and pings a synthetic peer. **A8 (the guest display and input in
> a unoui window) is in progress, 2026-08-21.** Everything after it - and all
