/* UnoDOS/PS2 - alpha-blend / gradient / rounded-corner framebuffer primitives.
 *
 ...
 * unoui (`./build.sh ee uui`) build. Pure C over the shared fb[] (see fb.h),
 * ported verbatim from pc64/fb.c - portable software ops, no platform deps.
 *
