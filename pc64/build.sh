...
OBJS=""
for f in fb mac_compat pc64_io pc64_libc pc64_math pc64_modload_static pc64_pci pc64_fs blkdev ahci nvme sdhci fat tls_ca e1000 net tls tls_entropy hid_kbd i2c_hid xhci usbio usbboot usbmsc usbhid detachgate unoamp_out unoamp_in unoamp_skin unoamp_vis unoamp_dsp unoamp_enc unoamp_mod unoamp_app unoamp_ui pc64_mtrr uefi_main pc64_native unodos snd_pcm hdaudio ac97; do
