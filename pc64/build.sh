...
if [ "$1" != "legacy" ]; then
    ...
    for f in fb mac_compat pc64_libc pc64_io pc64_pci pc64_math pc64_fs blkdev ahci nvme fat hid_kbd i2c_hid xhci usbhid ax88179 uefi_main pc64_native pc64_uui pc64_uui_apps pc64_modload pc64_games js pc64_http pc64_font pc64_browser pc64_icons e1000 net tls tls_ca acpi_host installer snd_pcm hdaudio ac97; do
...
OBJS=""
for f in fb mac_compat pc64_io pc64_libc pc64_math pc64_modload_static pc64_pci pc64_fs blkdev ahci nvme fat tls_ca e1000 net tls hid_kbd i2c_hid xhci usbhid uefi_main pc64_native unodos snd_pcm hdaudio ac97; do
